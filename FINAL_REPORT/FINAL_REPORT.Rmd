...
Furthermore, we created a correlation matrix with the dosages of the different drugs per ovary cell line and displayed the Pearson correlation in a heatmap. The blue and the purple squares indicate a high and negative correlation, showing that the higher the drug dosage the smaller the cell proliferation rates become (see Fig. 9).
