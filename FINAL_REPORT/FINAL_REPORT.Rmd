...
In order to predict drug efficiency from unrelated variables in ovarian cancer cell lines, we built a regression model using the drug disulfiram as the dependent variable. As unrelated variables we chose PCs of the data frames prism.achilles, prism.exp and prism.cnv with regard to the ovarian cell lines. We computed the linear regression model prior to the previous analysis steps, which is why we did not know that it might turn out insufficiently. 
...
```{r, echo=FALSE, fig.cap = "Pairwise Plots of Chosen Variables", fig.height=3.25, fig.width=8, fig.pos="H"}
