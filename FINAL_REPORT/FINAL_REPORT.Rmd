...
In order to make the linearity assumption, the residuals should be normally distributed [@kronthaler2020data]. We checked this with the help of a q-q plot and saw that this was not fully the case as several values lay outside the qq-line. In addition to that, the residuals show a correlation with our explanatory variables (`r cor(learning_regression$disulfiram, regression_model$residuals)`) which again revokes the linearity assumption (see. Fig. 11.a.). However, the residuals do have a mean value close to zero (`r mean(regression_model$residuals)`).
