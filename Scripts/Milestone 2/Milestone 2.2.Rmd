...
```{r r1 Milestone 2.1 - Inspect whether celllines show a different response to similar drugs according to specific mutations - KRAS,BRCA1,BRCA2}
...
# Creating groups of gene expression patterns of KRAS and BRCA1 from prism.achilles
ovary_achilles_kras_brca1 <- cbind(ovary_achilles_kras, ovary_achilles_brca1) 
print(ovary_achilles_kras_brca1)

# Creating groups of gene expression patterns of KRAS,BRCA1 and BRCA2
...
# Creating groups of gene expression patterns of KRAS and BRCA1 from prism.cnv
...
# Creating groups of gene expression patterns of KRAS and BRCA1 from prism.exp
...
# H1 hypothesis(alternative hypothesis) - true difference in means is less than zero// There is a dependenc eof the drug response on gene expression patterns
...
# Select the ovary cell lines from prism.achilles which belong to clusters 1,2, 3 and 4
...
# Inspect which genes have the highest variance, select them and convert them into a vector
# Genes with the highest variance are most similar to each other

max(ovary_achilles_var1, na.rm = TRUE) # no gene with variance 0.26
max(ovary_achilles_var2, na.rm = TRUE)
max(ovary_achilles_var3, na.rm = TRUE)
max(ovary_achilles_var4, na.rm = TRUE)
...
# Reduce prism.cnv dataset to the selected celllines from the clusters
...
max(ovary_cnv_cluster1, na.rm = TRUE)
max(ovary_cnv_cluster2, na.rm = TRUE)
max(ovary_cnv_cluster3, na.rm = TRUE)
max(ovary_cnv_cluster4, na.rm = TRUE)
...
# Reduce prism.exp dataset to the selected celllines from the clusters
...
max(ovary_exp_cluster1, na.rm = TRUE)
max(ovary_exp_cluster2, na.rm = TRUE)
max(ovary_exp_cluster3, na.rm = TRUE)
max(ovary_exp_cluster4, na.rm = TRUE)
...
t_test_ovary_drugs1 = t.test(achilles_vector_cluster1, moa_drugs_ovary ,alternative = 'greater', var.equal=TRUE, na.rm = TRUE)
t_test_ovary_drugs1



t_test_ovary_drugs2 = t.test(cnv_vector_cluster1, moa_drugs_ovary ,alternative = 'greater', var.equal=TRUE, na.rm = TRUE)
t_test_ovary_drugs2
