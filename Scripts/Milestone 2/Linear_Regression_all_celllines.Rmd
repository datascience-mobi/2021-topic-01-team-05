...
pca_A_achilles = prcomp(A_achilles_new, scale = TRUE)
...
```{r}
learning_celllines_all = sample(1:nrow(regression_data_no_nas_all), 240, replace = F)
...
rmse.check_all = sqrt(1/n_all*sum(residuals^2))
