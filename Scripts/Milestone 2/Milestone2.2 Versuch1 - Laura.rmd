...
##ranking the drugs
dplyr::arrange(pvalues_t_test_treat3vs1, Bonferroni)
```
...
##for each column df1 and df2 welch t-test (assuming anequal variance)
...
##creatig a dataframe with p-vaues and genes
pvalues_t_test_achilles_new1vs3<-rename(pvalues_t_test_achilles_new1vs3,p_value=mapply.function.x..y..t.test.x..y..alternative....two.sided...)
...
pvalues_t_test_achilles_new1vs3$BH <-
      p.adjust(pvalues_t_test_achilles_new1vs3$p_value,
               method = "BH")

pvalues_t_test_achilles_new1vs3$Holm <-
        p.adjust(pvalues_t_test_achilles_new1vs3$p_value,
               method = "holm")

pvalues_t_test_achilles_new1vs3$Hochberg <-
      p.adjust(pvalues_t_test_achilles_new1vs3$p_value,
               method = "hochberg")

pvalues_t_test_achilles_new1vs3$Hommel <-
      p.adjust(pvalues_t_test_achilles_new1vs3$p_value,
               method = "hommel")

pvalues_t_test_achilles_new1vs3$BY <-
      p.adjust(pvalues_t_test_achilles_new1vs3$p_value,
               method = "BY")
...
dplyr::arrange(pvalues_t_test_achilles_new1vs3, p_value)
```
...
##ranking the drugs
dplyr::arrange(pvalues_t_test_treat4vs1, Bonferroni)
```
...
##creatig a dataframe with p-vaues and genes
pvalues_t_test_achilles_new1vs4<-rename(pvalues_t_test_achilles_new1vs4,p_value=mapply.function.x..y..t.test.x..y..alternative....two.sided...)
...
pvalues_t_test_achilles_new1vs4$BH <-
      p.adjust(pvalues_t_test_achilles_new1vs4$p_value,
               method = "BH")

pvalues_t_test_achilles_new1vs4$Holm <-
        p.adjust(pvalues_t_test_achilles_new1vs4$p_value,
               method = "holm")

pvalues_t_test_achilles_new1vs4$Hochberg <-
      p.adjust(pvalues_t_test_achilles_new1vs4$p_value,
               method = "hochberg")

pvalues_t_test_achilles_new1vs4$Hommel <-
      p.adjust(pvalues_t_test_achilles_new1vs4$p_value,
               method = "hommel")

pvalues_t_test_achilles_new1vs4$BY <-
      p.adjust(pvalues_t_test_achilles_new1vs4$p_value,
               method = "BY")
...
dplyr::arrange(pvalues_t_test_achilles_new1vs4, p_value)
```
```{r}
## looking at the genes from cluster 1 and 4 and doing a t-test
##prism.exp
...
##creatig a dataframe with p-vaues and genes
pvalues_t_test_exp_1vs4<-rename(pvalues_t_test_exp_1vs4,p_value=mapply.function.x..y..t.test.x..y..alternative....two.sided...)
...
pvalues_t_test_exp_1vs4$BH <-
      p.adjust(pvalues_t_test_exp_1vs4$p_value,
               method = "BH")

pvalues_t_test_exp_1vs4$Holm <-
        p.adjust(pvalues_t_test_exp_1vs4$p_value,
               method = "holm")

pvalues_t_test_exp_1vs4$Hochberg <-
      p.adjust(pvalues_t_test_exp_1vs4$p_value,
               method = "hochberg")

pvalues_t_test_exp_1vs4$Hommel <-
      p.adjust(pvalues_t_test_exp_1vs4$p_value,
               method = "hommel")

pvalues_t_test_exp_1vs4$BY <-
      p.adjust(pvalues_t_test_exp_1vs4$p_value,
               method = "BY")
...
dplyr::arrange(pvalues_t_test_exp_1vs4, p_value)
```
...
##creatig a dataframe with p-vaues and genes
pvalues_t_test_cnv_1vs4<-rename(pvalues_t_test_cnv_1vs4,p_value=mapply.function.x..y..t.test.x..y..alternative....two.sided...)
...
pvalues_t_test_cnv_1vs4$BH <-
      p.adjust(pvalues_t_test_cnv_1vs4$p_value,
               method = "BH")

pvalues_t_test_cnv_1vs4$Holm <-
        p.adjust(pvalues_t_test_cnv_1vs4$p_value,
               method = "holm")

pvalues_t_test_cnv_1vs4$Hochberg <-
      p.adjust(pvalues_t_test_cnv_1vs4$p_value,
               method = "hochberg")

pvalues_t_test_cnv_1vs4$Hommel <-
      p.adjust(pvalues_t_test_cnv_1vs4$p_value,
               method = "hommel")

pvalues_t_test_cnv_1vs4$BY <-
      p.adjust(pvalues_t_test_cnv_1vs4$p_value,
               method = "BY")
...
dplyr::arrange(pvalues_t_test_cnv_1vs4, p_value)
```
