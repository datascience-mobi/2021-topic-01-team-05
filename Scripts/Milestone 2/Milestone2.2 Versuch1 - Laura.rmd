...
##using pivot wider
pivot_wider(df_ovary_prism_treat_effective_longc2c4, names_from = DepMap_ID,values_from= proliferationvalues)
...
##using pivot wider
pivot_wider(df_noovary_prism_treat_effective_longc2c4, names_from = DepMap_ID,values_from= proliferationvalues)
...
```
```{r}
for (drug in colnames(df_ovary_prism_treat_effective[-c(1,2,3,4),]){ for gene in colnames(rownames(reduced_ovary_achilles)){cor(df_ovary_prism_treat_effective$name, rownames(reduced_ovary_achilles))}})
