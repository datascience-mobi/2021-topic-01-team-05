...
df_ovary_DepMI_dose
##package thiDr (wie ordentlich) R anschauen um jede observation in eigene Zeile machen. tieDr 

```
```{r}
install.packages("tidyr", repos=c("http://rstudio.org/_packages", "http://cran.rstudio.com"))
...
plot(df_ovary_DepMI_dose_NA$dose,
     df_ovary_DepMI_dose_NA$"ACH-000013",
     xlab='dosage',
...
histMeanMedCol(df_ovary_DepMI_dose_NA$`ACH-000013`, "pink","green")
####würde ich gerne mit sapply auf alle Zellen anwenden Wie?
```
