...
###mhdac war am meisten dann clustern nach cell lines oder welche gene passen
### verhaältnis von hdac inhibitors bei cancer cell lines im gegensatz zu allen mal schauen--> wilkixon test, (fisher, chi square -> gut für kategorisch gegen kategorisch)
...
as.vector(na.omit((prism.treat_reduced_2[prism.treat_reduced_2$moa == "HDAC inhibitor",])$broad_id)) 

## Extracting the cell lines from prism using the above extracted broad IDs
prism[prism$colnames == as.vector(na.omit((prism.treat_reduced_2[prism.treat_reduced_2$moa == "HDAC inhibitor",])$broad_id)) ]

```


```{r S13 Trying to cluster ANYTHING}
