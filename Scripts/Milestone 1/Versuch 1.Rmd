...
data.frame(min_values_cl_prism_reduced_ovary)
#data.frame(apply(prism_reduced_ovary, 2, min, na.rm=TRUE))
```
...
ggplot(prism_reduced, aes(x = prism_reduced[1:481,], y = prism_reduced[,1:1394])) + geom_point()
