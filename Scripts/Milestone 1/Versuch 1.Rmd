...
km <- kmeans(prism_reduced_ovary_no_NAs[!is.na(prism_reduced_ovary_no_NAs)], centers=5)
...
dim(km)
fviz_nbclust(scale(prism_reduced_ovary_no_NAs[!is.na(prism_reduced_ovary_no_NAs)]), kmeans, nstart=10, method = "wss") + 
