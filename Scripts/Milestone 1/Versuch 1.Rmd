...
## Creating a vector with all of the min values in prism_reduced under the threshold of the 10% quantile
...
```{r S10 Finding out if the medications in the 10% quantile are oncological/non-oncological}
...
```{r S11 Trying to cluster ANYTHING}
