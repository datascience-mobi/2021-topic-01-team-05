...
wss_ovary = sapply(2:15,function(k) { 
...
```{r - c4.12. visualizing the clustering of ovary cell lines based on their drug response after performin PCA}
...
plot(2:15,wss,type='b',pch=20,xlab="Number of clusters K",
     ylab="Total within-clusters sum of squares")
...
barplot(sort(pca1_moa$rotation[,1]), las=3)

barplot(sort(pca1_moa$rotation[,2]), las=3)
