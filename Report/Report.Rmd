...
barplot(pca2_var_per_moa, main = "Variance explained by mechanism of action PCs", xlab = "Principal component", ylab = "Percent variation")
```

As a result, the majority of the variance is explained by using the first two principal components. 
...
# 2nd pc
barplot(sort(pca2_moa$rotation[,2]), las=3, cex.names = 0.4, main = "Contribution to PC2")


which(sort(pca2_moa$rotation[,2]) < 0)
