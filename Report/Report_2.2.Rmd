...
# First trial 
df_1 <- pvalues_t_test_treat3vs2_reduced
...
t1 <- kable(pvalues_t_test_exp_2vs3_reduced, format = "latex", booktabs = TRUE)
t2 <- kable(pvalues_t_test_cnv_2vs3_reduced, format = "latex", booktabs = TRUE)
