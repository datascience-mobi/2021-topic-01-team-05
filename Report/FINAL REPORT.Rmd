...
There are significant differences in the drug response for some drugs shown in table 1.
...
description_drug_vector<- c("HDAC inhibitor [Quelle]","tyrosine kinase inhibitor [Quelle]","CDK9 inhibitor [Quelle]")
