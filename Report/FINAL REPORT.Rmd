...
disease_area_vector<- c("non-oncological [Quelle]","oncological [Quelle]", "oncological [Quelle]")
...
knitr::kable(pvalues_t_test_treat3vs1_reduced,
           caption = "Table of drugs with a significant different response for clusters 1 and 3")
